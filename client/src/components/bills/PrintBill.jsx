            ...
            <div className="bill-details">
              <div className="grid sm:grid-cols-4 grid-cols-3 gap-12">
                <div className="text-md text-slate-500">
                  ...
                  <p className="font-bold text-blue-700">{customer?.costumerName}</p>
                  <p> Fake Street 123</p>
                  <p> San Javier </p>
                  <p> CA 1234</p>
                </div>
              ...
              <table className="min-w-full divide-y divide-slate-500 overflow-hidden">
                ...
                <tbody>
                  {customer?.cardItems.map((item, index) => (
                    <tr className="border-b border-slate-200" key={item.id || index}>
              ...
              <div className="py-9">
                <div className="border-t pt-9 border-slate-200">
                  <p className="text-sm font-light text-slate-700">
                    Payment terms are 14 days. According to the Unwrapped Debt
                    Payment Act 0000, freelancers have the right to claim a late
                    fee of 00.00 after this period if debts are unpaid, and a
                    new invoice will be issued in addition to this fee. If the
                    revised invoice is not paid within 14 days, an additional
                    interest of 8% plus 0.5% Bank of England base, totaling
                    8.5%, will be applied to the overdue account. Parties cannot
